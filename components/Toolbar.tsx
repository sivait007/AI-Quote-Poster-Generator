...
interface ToolbarProps {
  ...
  onGenerateQuote: (topic: string) => void;
        ...
        {activeTab === 'ai' && (
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-xs text-gray-500 mb-2">Generate a unique quote on any topic.</p>
                    <div className="flex space-x-2">
                        ...
                        <button onClick={() => onGenerateQuote(aiQuoteTopic)} disabled={isAiLoading} className="px-4 py-2 bg-posterly-purple text-white rounded-lg hover:opacity-90 disabled:opacity-50 transition-opacity">
                            {isAiLoading ? '...' : 'Go'}
                        </button>
                    </div>
                </div>
